    ...
    for idx in tqdm(range(cfg.sample_num)):
        while True:
            try:
                ...
                is_txt.write(str(idx) + '.png' + ' ' + is_text + '\n')
                it_txt.write(str(idx) + '.png' + ' ' + it_text + '\n')
                font_txt.write(str(idx) + '.png' + ' ' + font_name + '\n')
                ...
                t_t_path = os.path.join(t_t_dir, str(idx) + '.png')
                t_b_path = os.path.join(t_b_dir, str(idx) + '.png')
                t_f_path = os.path.join(t_f_dir, str(idx) + '.png')
                s_s_path = os.path.join(s_s_dir, str(idx) + '.png')
                mask_t_path = os.path.join(cfg.data_dir, cfg.mask_t_dir, str(idx) + '.png')
                mask_s_path = os.path.join(cfg.data_dir, cfg.mask_s_dir, str(idx) + '.png')
